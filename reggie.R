...
init_fs_vol_regionlabel_list <- function() {
  fs_vol_regionlabel_list = c("INFLATVENT","LATVENT","THIRDVENT","FOURTHVENT",
                              "FIFTHVENT","BRAINSTEM","CRPCLM_ANT",
                              "CRPCLM_CNTRL","CRPCLM_MID_ANT","CRPCLM_MID_POST",
                              "CRPCLM_POST","OPTICHIASM","VESSEL",
                              "NONWMHYPOINTENSITIES","NONWMHYPOINTENSITIES",
                              "WMHYPOINTENSITIES","ACCUMBENS","AMYGDALA",
                              "CAUD","CHORPLEX","HIPPOCAMPUS","PALLIDUM",
                              "PUTAMEN","THALAMUS","VENTRALDC","SSTSBANK",
                              "CAUDANTCNG","CAUDMIDFRN","CUNEUS","ENTORHINAL",
                              "FRNPOLE","FUSIFORM","INFRPRTL","INFRTMP",
                              "INSULA","ISTHMUSCNG","LATOCC","LATORBFRN",
                              "LINGUAL","MEDORBFRN","MIDTMP","PARACNTRL",
                              "PARAHPCMPL","PARAOPRCLRS","PARSORBLS",
                              "PARSTRNGLRS","PERICLCRN","POSTCNG","POSTCNTRL",
                              "PRECNTRL","PRECUNEUS","ROSANTCNG","ROSMIDFRN",
                              "SUPERFRN","SUPERPRTL","SUPERTMP","SUPRAMRGNL",
                              "TMPPOLE","TRANSTMP")
  
  fs_vol_regionlabel_list
}
...
##TO-DO: replace NAs in specified columns with ""
